...
/* Questions:  
   what is demand fetching? answer: whenever you fetch a block from memory.
   ...
   If you  write alloc the first time and you have write through , Do you access the memory twice then? answer: yes ;
